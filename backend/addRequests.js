...
const addSampleRequests = async () => {
  try {
    ...
    const caseCreationRequests = [
      { title: "New Case RR 1", description: "Request for a new case.", requestedBy: user._id, status: "pending" },
      { title: "New Case RR 2", description: "Request for another case.", requestedBy: user._id, status: "approved" },
    ];
